...
<body class="border">
    <form method="post" id="login">
        <div class="form">
            ...
            <h2 class="font header">Zaloguj się</h2>
            ...
            <a href="register.php" class="link">Nie masz konta?</a>
            <button type="submit" class="button font"> Zaloguj się</button>
